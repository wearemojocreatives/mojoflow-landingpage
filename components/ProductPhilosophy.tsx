...
export default function ProductPhilosophy() {
  const cards = [
    ...
    },
    {
      ...
      description: 'Your rates, deliverable packages, and deal terms belong to your business. Your commercial data stays inside your private workspace.',
    },
    {
      title: 'You know your numbers',
      icon: TrendingUp,
      color: 'from-emerald-500/20 to-teal-500/10 border-emerald-500/30 text-emerald-400',
      description: 'Track agreed commercial value, production expenses, Net payment terms, invoices, and actual net creator profit for every collaboration.',
    },
  ];

  return (
    <section id="why-mojo" className="py-24 bg-mojo-bg border-t border-mojo-border/60 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {cards.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="glass-card p-7 rounded-2xl border border-mojo-border/80 hover:border-mojo-violet/40 transition-all duration-300 hover:-translate-y-1 space-y-4 text-left"
              >
